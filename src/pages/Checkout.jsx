      ...
      <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12">
        ...
        <Card className="overflow-hidden rounded-3xl bg-white/[0.04] border border-white/10 backdrop-blur-xl">
          ...
          <CardContent className="p-8 space-y-6">
            <span className="inline-flex px-4 py-1 rounded-full text-xs font-semibold bg-[#7CFF4D]/15 text-[#7CFF4D]">
              {state.category}
            </span>
            ...
            <div className="border-t border-white/10 pt-6 space-y-2 text-sm">
              ...
              <div className="flex justify-between pt-4 border-t border-white/10 text-lg font-bold text-[#7CFF4D]">
                <span>Total</span>
          ...
          <CardContent className="p-10 space-y-8">
            <div>
              ...
              <p className="text-white/60 mt-2">
                Pemesanan akan dilanjutkan via WhatsApp
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  className="mt-2 bg-black/40 border-white/10 text-white placeholder:text-white/40 focus:border-[#7CFF4D]"
            ...
            <div className="space-y-4 pt-4">
              <Button
                ...
                disabled={!name || !phone}
                className="w-full py-6 rounded-xl bg-[#7CFF4D] text-[#05080f] font-semibold hover:brightness-110"
              >
              ...
              <Button
                variant="outline"
                onClick={() => navigate(-1)}
                className="w-full py-6 rounded-xl border-white/20 bg-white/[0.03] text-white/70 hover:bg-white/[0.08]"
              >
